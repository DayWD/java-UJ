...
- W razie braku 1 parametru ( parametrów? ), program powinien wypisać na *System.out*: `Please specify command.`, oraz zwrócić kod błędu 1.
...
️▶️ Jeśli nie wskazano pliku, należy wypisac na *System.out*: `Please specify file to add.`, oraz zwrócić kod błędu 20. 
...
- ▶️ jeśli plik nie istnieje wypisać na *System.out*: `File {file-name} not found.`, oraz zwrócić kod błędu 21.
...
#### checkout
Przywraca plik do stanu z konkretnej, wskazanej w parametrze, wersji.
